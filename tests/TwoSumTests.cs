...
{
    private static readonly int[] Array1 = [1, 5, 3, 7, 02, 8];
    ...
    private static readonly int[] Array20 = [1, 5, 3, 7, 10, 10, 09];
    ...
    private static readonly int[] Array30 = [1, 5, 3, 7, 12, 08];
    ...
    private static readonly int[] Array41 = [1, 5, 3, 7, 10, 09];
    ...
    private static readonly int[] Array52 = [1, 5, 3, 7, 12, 09];
