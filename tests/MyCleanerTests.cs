...
public class MyCleanerTests
{
    ...
    {
        // Act 
        string actual = MyCleaner.CleanUrl(input);
    ...
    public void CleanUrl_ShouldReturnValidOutputForOjrq(string input, string expectedOutput)
    {
        // Act 
        string actual = MyCleaner.CleanUrl(input);
        actual.Should().Be(expectedOutput);
    ...
    public void CleanUrl_ShouldReturnValidOutputForTkqlhce(string input, string expectedOutput)
    {
        // Act 
        string actual = MyCleaner.CleanUrl(input);
        actual.Should().Be(expectedOutput);
